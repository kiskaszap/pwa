...
//   const completedItems = tasks.filter((task) => completed.includes(task.id));
...
//         <p className="text-center text-gray-400">No tasks completed yet.</p>
//       ) : (
...
//               {task.type === "photo" && (
//                 <img
//                   src={localStorage.getItem(`photo-${task.id}`)}
//                   alt="Uploaded"
...
//               {task.type === "text"  && (
//                 <p className="text-sm text-green-400">You answered this question.</p>
//               )}

//               {task.type === "quiz" && (
//                 <p className="text-sm text-green-400">You answered this quiz.</p>
//               )}
//             </div>
//           ))}
//         </div>
...
//       const completedTaskIds = email ? JSON.parse(localStorage.getItem(`completedTasks-${email}`) || "[]") : [];
